...
(function () {
  ...
  const DICTIONARY = {
    "en": {
      ...
      "tweaks.section.shortcuts": "Shortcuts",
      "tweaks.shortcut.quickBar": "Toggle Quick Bar",
      "tweaks.shortcut.screenshot": "Region screenshot",
      "tweaks.shortcut.recording": "Press keys…",
      "tweaks.shortcut.reset": "Reset",
      ...
      "composer.imageMenu.trigger": "Add image or screenshot",
      "composer.imageMenu.upload": "Upload image…",
      "composer.imageMenu.screenshot": "Capture screen",
      "composer.unsupportedVision": 'Current model "{model}" may not natively support images — omp can use tools to read them',
      ...
      "composer.warn.vision": 'Current model "{model}" may not natively support images — omp will use tools to read them.',
      ...
      "quickbar.screen.off": "screen off",
      "quickbar.screen.auto": "screen on",
      "quickbar.screen.region": "region captured",
      "quickbar.screen.tooltip.off": "Ask about screen: click to enable auto-screenshot on send",
      "quickbar.screen.tooltip.auto": "Auto-screenshot on send (click to turn off, Alt+S for region)",
      "quickbar.screen.tooltip.region": "Region captured (click to switch to auto, Alt+S to re-capture)",
      "quickbar.placeholder.screen": "Ask about this screen…",
      "quickbar.hint.region": "region capture",
      "quickbar.removeImage": "remove screenshot",
    ...
    "zh-CN": {
      ...
      "tweaks.section.shortcuts": "快捷键设置",
      "tweaks.shortcut.quickBar": "呼出 Quick Bar",
      "tweaks.shortcut.screenshot": "选区截屏",
      "tweaks.shortcut.recording": "按下快捷键…",
      "tweaks.shortcut.reset": "恢复默认",
      "tweaks.close": "关闭设置",
      ...
      "composer.imageMenu.trigger": "添加图片或截屏",
      "composer.imageMenu.upload": "上传本地图片…",
      "composer.imageMenu.screenshot": "截取屏幕",
      "composer.unsupportedVision": '当前模型 "{model}" 可能不原生支持图片 — omp 会通过工具读取',
      "composer.dictate": "语音输入",
      "composer.bridgeKbd": "打开指令桥 (Ctrl+K)",
      "composer.hints.normal": "↵ 发送 · ⇧↵ 换行 · ⎋ 中止",
      "composer.hints.steer": "↵ 引导 · ⎋ 中止",
      "composer.warn.vision": '当前模型 "{model}" 可能不原生支持图片输入，omp 会通过工具来读取图片内容。',
      ...
      "quickbar.copied": "已复制！",
      "quickbar.screen.off": "关闭截屏",
      "quickbar.screen.auto": "依据屏幕提问",
      "quickbar.screen.region": "已选区域",
      "quickbar.screen.tooltip.off": "依据屏幕提问：点击开启发送时自动截屏",
      "quickbar.screen.tooltip.auto": "发送时自动截屏（点击关闭，Alt+S 选区截屏）",
      "quickbar.screen.tooltip.region": "已截取选区（点击切换为自动截屏，Alt+S 重新框选）",
      "quickbar.placeholder.screen": "依据当前屏幕提问…",
      "quickbar.hint.region": "选区截屏",
      "quickbar.removeImage": "移除截屏",
